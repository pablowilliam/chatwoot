class Public::Api::V1::Inboxes::MessagesController < Public::Api::V1::InboxesController
  ...
  def check_csat_locked
    lock_period = @conversation.inbox.csat_lock_period_days || 14 # Usa el valor de bloqueo configurado o 14 por defecto
    (Time.zone.now.to_date - @message.created_at.to_date).to_i > lock_period && @message.content_type == 'input_csat'
  end
end
