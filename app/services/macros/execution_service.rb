class Macros::ExecutionService < ActionService
  ...
  def sleep_m(params)
    duration = params[0].to_i # toma el primer valor del parámetro como duración
    sleep(duration) if duration.positive? # pausa la ejecución durante la cantidad de segundos especificada
  end
