class AdministratorNotifications::ChannelNotificationsMailer < ApplicationMailer
  def slack_disconnect
    ...
    subject = I18n.t('mailers.administrator_notifications.channel_notifications.slack_disconnect.subject')
  ...
  def dialogflow_disconnect
    ...
    subject = I18n.t('mailers.administrator_notifications.channel_notifications.dialogflow_disconnect.subject')
    send_mail_with_liquid(to: admin_emails, subject: subject) and return
  end
  ...
  def facebook_disconnect(inbox)
    ...
    subject = I18n.t('mailers.administrator_notifications.channel_notifications.facebook_disconnect.subject')
  ...
  def whatsapp_disconnect(inbox)
    ...
    subject = I18n.t('mailers.administrator_notifications.channel_notifications.whatsapp_disconnect.subject')
    @action_url = "#{ENV.fetch('FRONTEND_URL', nil)}/app/accounts/#{Current.account.id}/settings/inboxes/#{inbox.id}"
    send_mail_with_liquid(to: admin_emails, subject: subject) and return
  end
  ...
  def email_disconnect(inbox)
    ...
    subject = I18n.t('mailers.administrator_notifications.channel_notifications.email_disconnect.subject')
    @action_url = "#{ENV.fetch('FRONTEND_URL', nil)}/app/accounts/#{Current.account.id}/settings/inboxes/#{inbox.id}"
    send_mail_with_liquid(to: admin_emails, subject: subject) and return
  end
  ...
  def contact_import_complete(resource)
    ...
    subject = I18n.t('mailers.administrator_notifications.channel_notifications.contact_import_complete.subject')
  ...
  def contact_import_failed
    ...
    subject = I18n.t('mailers.administrator_notifications.channel_notifications.contact_import_failed.subject')
  ...
  def contact_export_complete(file_url, email_to)
    ...
    @action_url = file_url
    subject = I18n.t('mailers.administrator_notifications.channel_notifications.contact_export_complete.subject')
  ...
  def automation_rule_disabled(rule)
    ...
    subject = I18n.t('mailers.administrator_notifications.channel_notifications.automation_rule_disabled.subject')
    @meta = {}
